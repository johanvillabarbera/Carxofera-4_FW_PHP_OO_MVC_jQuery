<?php
	class search_bll {
		...
		public function get_select_model_BLL() {
			return $this -> dao -> select_model($this->db);
		}

		public function get_select_model_brand_BLL($args) {
			return $this -> dao -> select_model_brand($this->db, $args);
		}

		public function get_select_brand_BLL() {
			return $this -> dao -> select_brand($this->db);
		}

		public function get_select_auto_model_BLL($args) {
			return $this -> dao -> select_auto_model($this->db, $args[0], $args[1]);
		}

		public function get_select_auto_model_brand_BLL($args) {
			return $this -> dao -> select_auto_model_brand($this->db, $args[0], $args[1], $args[2]);
		}

		public function get_select_auto_brand_BLL($args) {
			return $this -> dao -> select_auto_brand($this->db, $args[0], $args[1]);
		}
